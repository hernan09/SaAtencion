...
export class Config {
	public static OPTIONS = {
		...
		VERSION_NUMBER : '1.0.22.9.preprod'
	}
	...
	public static MSG = {
		...
		// TIMEOUT_ERROR: 'Lo sentimos. No podemos procesar tu solicitud en este momento. Por favor, intenta nuevamente más tarde o comunicate al 0800-444-3511',
		TIMEOUT_ERROR: 'No podemos procesar tu solicitud en este momento. Por favor, intenta nuevamente más tarde o comunicate al 0800-444-3511',
		...
		CONNECTION_ERROR : 'No podemos procesar tu solicitud en este momento. Por favor, intente nuevamente más tarde.',
